...
Var(t) &= Var(f_i)[\sum_{i = 1}^N Y_i^2 -\frac{1}{N-1} \sum_{i = 1}^N Y_i Y_j] \\
       ...
       &= Var(f_i)\frac{N}{N-1}[\sum_{i = 1}^N Y_i^2 - N^2\mu^2] \\
...
s^2 &= \frac{\sum_{i \in s} (Y_i - \bar y)^2}{n-1} \\
 ...
 &= \sum_{i \in s} Y_i^2 - 2\bar y\sum_{i \in s}Y_i + \bar y^2\\
 &= \sum_{i \in s} Y_i^2 - 2\bar yn\bar y + \bar y^2\\
 &= \sum_{i \in s} Y_i^2 - 2\bar y^2n + \bar y^2\\
